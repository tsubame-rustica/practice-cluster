...
namespace Assets.KaomoLab.CSEmulator.Editor.Engine
{
    public class ItemCollector
    {
        ...
        public event Handler<ClusterVR.CreatorKit.Item.IItem> OnPlainItemCreated = delegate { };
        ...
        public IEnumerable<ClusterVR.CreatorKit.Item.IItem> GetAllPlainItems()
        {
            var items = UnityEngine.SceneManagement.SceneManager.GetActiveScene()
                .GetRootGameObjects()
                .SelectMany(
                ...
                .Where(i => !i.gameObject.TryGetComponent<ClusterVR.CreatorKit.Item.IScriptableItem>(out _));
